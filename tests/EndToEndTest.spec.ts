...
async function performRegistration(page: Page): Promise<string> {
    ...
    await homePage.myAccount.click();       // Click "My Account" link
    await homePage.registerOption.click();        // Click "Register" option
...
async function addProductToCart(page: Page) {
    ...
    await homePage.searchBox.fill(productName);
    await homePage.searchButton.click();  // Click on search button
